package com.tameme.cobranza.common.config;
...
public class JasperReportManager {
	...
	public static final String RPT_EXCEL = "XLS";
	public static final String RPT_PDF = "PDF";
	...
	public ByteArrayOutputStream export(String fileName, String tipoReporte, Map<String, Object> params,
		...
		if (tipoReporte.equals(JasperReportManager.RPT_EXCEL)) {
